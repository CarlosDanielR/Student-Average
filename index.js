...
/* Outra opção, de acordo com numeros de alunos:
var vetor1=[], 
var vetor2=[];

for(i=0;i<10;i++){
 vetor1[i]=parseInt(prompt("Insita numeros de 0 a 10 vet.1: "));

}

for(i=0;a<10;a++){
 vetor2[a]=parseInt(prompt("Insita numeros de 0 a 10 vet.1: "));
